...
- `/print/hospitalizacion/rondas` imprime ronda de lectura con ingresos
  activos, cama y ultima hoja diaria; declara fuentes
  `hospitalization/active` y `hospital_daily_sheets` y no equivale a orden ni
  firma legal
