...
superficies con write ABAC dev-only; el resto sigue sin write ABAC y ninguna
escritura tiene ABAC runtime productivo. La cobertura de lectura no autoriza
escrituras por relacion asistencial.
