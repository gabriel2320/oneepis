...
- Existe contrato shadow de escrituras clinicas para inventario y requisitos
  pre-runtime; signos vitales, clinical risks y clinical entries tienen write
  ABAC dev-only, las demas escrituras siguen sin write ABAC y ninguna hereda
  autorizacion de la cobertura de lectura.
