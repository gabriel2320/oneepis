...
- Los headers contextuales siguen rechazados y auditados; `break_glass_enabled`,
  `patient_scoping_enabled` y `abac_runtime_enforced` siguen en `False`.
- Falta enforcement runtime, motivo de acceso operativo, revision break-glass,
