...
export const screenCapabilities: ScreenCapability[] = [
  ...
  capability("/consulta/pacientes/[patientId]/atencion", "Ambulatorio", "acto clinico", "completa", "encuentros + SOAP + preconsulta", "clinical_write", "medico/admin/dev", "writes", "none", AI.draft, "preconsulta y cierre minimos; diagnosticos finales futuros"),
