...
export const screenCapabilities: ScreenCapability[] = [
  ...
  capability("/configuracion/ia", "Acceso/configuracion", "seguimiento", "completa", "AI status", "none", "sesion local", "none", "none", AI.read, "IA externa bloqueada hasta gateway PHI"),
  ...
  capability("/consulta/pacientes/[patientId]/atencion", "Ambulatorio", "acto clinico", "completa", "encuentros + SOAP + preconsulta", "clinical_write", "medico/admin/dev; preconsulta enfermeria/medico/admin/dev", "writes", "none", AI.draft, "preconsulta minima con workflow_kind; diagnosticos finales futuros"),
  ...
  capability("/hospitalizacion/pacientes/[patientId]/epicrisis", "Hospitalizacion", "documento", "completa", "clinical entry discharge_summary", "clinical_write", "medico/admin/dev", "writes", "carta", AI.draft, "firma/cierre legal futuros"),
  capability("/hospitalizacion/pacientes/[patientId]/ingreso", "Hospitalizacion", "documento", "completa", "clinical entry intake", "clinical_write", "medico/admin/dev", "writes", "carta", AI.draft, "borrador no firmado"),
  ...
  capability("/pacientes/[patientId]/ai-chart", "IA clinica", "acto clinico", "completa", "AI-Chart + Assistant Read", "clinical_patch", "medico/admin/dev + permiso IA", "patch_writes", "SOAP carta", AI.patch, "mantener v0.4 cerrado"),
  ...
  capability("/pacientes/[patientId]/encuentros/nuevo", "Episodios", "episodio", "completa", "API encuentros", "clinical_write", "medico/admin/dev", "writes", "none", AI.none, "preconsulta minima en atencion; admision avanzada futura"),
  ...
  capability("/pacientes/[patientId]/eventos", "Nucleo paciente", "acto clinico", "completa", "clinical events", "clinical_write", "escritura clinica", "writes", "none", AI.read, "curaduria de antecedentes"),
  ...
  capability("/pacientes/[patientId]/ficha", "Nucleo paciente", "paciente", "completa", "record paciente", "none", "lectura paciente", "none", "carta", AI.summary, "antecedentes/resultados minimos"),
  ...
  capability("/print/hospitalizacion/pacientes/[patientId]/epicrisis/[entryId]", "Documentos/papel", "documento", "completa", "clinical entry discharge_summary", "none", "lectura paciente", "none", "carta", AI.none, "borrador no firmado"),
  ...
  capability("/print/hospitalizacion/pacientes/[patientId]/ingreso/[entryId]", "Documentos/papel", "documento", "completa", "clinical entry intake", "none", "lectura paciente", "none", "carta", AI.none, "borrador no firmado"),
