...
export const hospitalPhysicalLocations: HospitalPhysicalLocation[] = [
  ...
  },
  {
    ...
    relatedRoutes: ["/configuracion", "/configuracion/api", "/configuracion/apariencia", "/configuracion/ia"],
    zone: "acceso",
    status: "available",
  ...
  },
  {
    ...
    relatedRoutes: ["/hospitalizacion", "/hospitalizacion/camas", "/hospitalizacion/rondas"],
    zone: "area-clinica",
    status: "available",
    accessPolicy: "patient_read",
    actionLabel: "Entrar",
