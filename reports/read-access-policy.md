...
Generado: 2026-06-25T01:50:20.647Z
...
GET /api/v1/patients/{patient_id}/assistant/timeline (apps/api/src/oneepis_api/api/v1/routes/patient_assistant.py) | clinical_timeline | AUDIT_REQUIRED_P0 | primera_implementacion | interactive_sensitive | strict_access_trail | report-only | Lectura clinica sensible o documental; debe dejar trail antes de produccion.
