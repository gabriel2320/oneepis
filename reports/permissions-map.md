...
Generado: 2026-06-25T02:11:14.332Z

## Resumen

- Rutas mutantes clinicas revisadas: 42
- Brechas criticas: 0
- Advertencias: 15
...
--- | --- | --- | --- | --- | --- | ---
POST /patients/{patient_id}/appointments (apps/api/src/oneepis_api/api/v1/routes/appointments.py) | create_patient_appointment | EncounterActorDep | record_audit_event | no detectado | OK | NO_403_TEST_DETECTED
PATCH /patients/{patient_id}/appointments/{appointment_id} (apps/api/src/oneepis_api/api/v1/routes/appointments.py) | update_patient_appointment | EncounterActorDep | record_audit_event | no detectado | OK | NO_403_TEST_DETECTED
POST /beds (apps/api/src/oneepis_api/api/v1/routes/hospitalization.py) | create_hospital_bed | EncounterActorDep | record_audit_event | no detectado | OK | NO_403_TEST_DETECTED
PATCH /beds/{bed_id} (apps/api/src/oneepis_api/api/v1/routes/hospitalization.py) | update_hospital_bed | EncounterActorDep | record_audit_event | no detectado | OK | NO_403_TEST_DETECTED
...
POST /{patient_id}/allergies (apps/api/src/oneepis_api/api/v1/routes/patient_allergies.py) | create_allergy | AllergyActorDep | record_audit_event | no detectado | OK | NO_403_TEST_DETECTED
PATCH /{patient_id}/allergies/{allergy_id} (apps/api/src/oneepis_api/api/v1/routes/patient_allergies.py) | update_allergy | AllergyActorDep | record_audit_event | no detectado | OK | NO_403_TEST_DETECTED
DELETE /{patient_id}/allergies/{allergy_id} (apps/api/src/oneepis_api/api/v1/routes/patient_allergies.py) | delete_allergy | AllergyActorDep | record_audit_event | no detectado | OK | NO_403_TEST_DETECTED
POST /{patient_id}/clinical-risks (apps/api/src/oneepis_api/api/v1/routes/patient_clinical_risks.py) | create_clinical_risk | ClinicalRiskActorDep | record_audit_event | no detectado | OK | NO_403_TEST_DETECTED
PATCH /{patient_id}/clinical-risks/{risk_id} (apps/api/src/oneepis_api/api/v1/routes/patient_clinical_risks.py) | update_clinical_risk | ClinicalRiskActorDep | record_audit_event | no detectado | OK | NO_403_TEST_DETECTED
...
PATCH /{patient_id} (apps/api/src/oneepis_api/api/v1/routes/patient_core.py) | update_patient | PatientActorDep | record_audit_event | no detectado | OK | NO_403_TEST_DETECTED
POST /{patient_id}/encounters (apps/api/src/oneepis_api/api/v1/routes/patient_encounters.py) | create_clinical_encounter | CurrentUserDep | record_audit_event | apps/api/tests/test_patient_permissions.py | OK | OK
...
POST /{patient_id}/clinical-events (apps/api/src/oneepis_api/api/v1/routes/patient_events.py) | create_clinical_event | ClinicalEventActorDep | record_audit_event | no detectado | OK | NO_403_TEST_DETECTED
PATCH /{patient_id}/clinical-events/{event_id} (apps/api/src/oneepis_api/api/v1/routes/patient_events.py) | update_clinical_event | ClinicalEventActorDep | record_audit_event | no detectado | OK | NO_403_TEST_DETECTED
POST /{patient_id}/lab-panels (apps/api/src/oneepis_api/api/v1/routes/patient_lab_panels.py) | create_lab_panel | LabResultActorDep | record_audit_event | no detectado | OK | NO_403_TEST_DETECTED
PATCH /{patient_id}/lab-panels/{panel_id} (apps/api/src/oneepis_api/api/v1/routes/patient_lab_panels.py) | update_lab_panel | LabResultActorDep | record_audit_event | no detectado | OK | NO_403_TEST_DETECTED
PATCH /{patient_id}/lab-panels/{panel_id}/results/{result_id} (apps/api/src/oneepis_api/api/v1/routes/patient_lab_panels.py) | update_lab_result | LabResultActorDep | record_audit_event | no detectado | OK | NO_403_TEST_DETECTED
