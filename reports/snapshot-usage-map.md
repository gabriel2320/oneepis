...
Generado: 2026-06-24T22:15:20.157Z

## Resumen

- Read models frontend: 15
- Snapshots/proyecciones: 5
- Read models sin consumidor visible: 6
...
getPatientRecord | patient-record-snapshot | /api/v1/patients/{patientId}/record | PatientRecordSnapshot | apps/web/src/lib/api/patients.ts | apps/web/src/components/clinical/patient-page-shared.tsx, apps/web/src/components/print/clinical-print.tsx, apps/web/src/components/print/hospital-indication-print.tsx
...
getClinicalTimeline | timeline-projection | /api/v1/patients/{patientId}/timeline?limit=50 | ClinicalTimeline | apps/web/src/lib/api/clinical-record.ts | no detectado
...
listClinicalEncounters | entity-list | /api/v1/patients/{patientId}/encounters?limit=50 | ClinicalEncounter[] | apps/web/src/lib/api/clinical-record.ts | apps/web/src/components/clinical/ambulatory-visit-pages.tsx, apps/web/src/components/clinical/patient-event-pages.tsx, apps/web/src/components/clinical/patient-record-workspaces.tsx, apps/web/src/components/clinical/patient-soap-page.tsx
